...
function validateForm_Submitappform() {
	with (document.Submitappform) {
       ...
       if (Edu_UG_Pc.value == "") alertMsg += "\n".concat(gt.gettext('UGPc')); 
        ...
        // Referee1 Email CONFIRMATION Validation
        var Ref1EmailConfirm=document.Submitappform.Referee1EmailConfirm;
        if (Ref1EmailConfirm.value == ""){
        	bootstrapAlert("Referee1EmailConfirm")
        	//alert(gt.gettext('Error').concat("\n\n").concat(gt.gettext('Referee1EmailConfirm')));
        		Ref1EmailConfirm.value="";
        		Ref1EmailConfirm.focus();
        		return false;
        	}
        
        if (echeck(Ref1EmailConfirm.value)==false){
        	Ref1EmailConfirm.value="";
        	Ref1EmailConfirm.focus();
            return false;
        }
        ...
        // Referee2 Email CONFIRMATION Validation
        var Ref2EmailConfirm=document.Submitappform.Referee2EmailConfirm;
        if (Ref2EmailConfirm.value == ""){
        	bootstrapAlert("Referee2EmailConfirm")
        	//alert(gt.gettext('Error').concat("\n\n").concat(gt.gettext('Referee2EmailConfirm')));
        		Ref2EmailConfirm.value="";
        		Ref2EmailConfirm.focus();
        		return false;
        	}
        
        if (echeck(Ref2EmailConfirm.value)==false){
        	Ref2EmailConfirm.value="";
        	Ref2EmailConfirm.focus();
            return false;
        }
    ...
    // Sat Oct 25 2014
	// Implementation for comparing the Referee Email address.
	var ref1Email = document.Submitappform.Referee1Email.value;
	var ref1EmailConfirm = document.Submitappform.Referee1EmailConfirm.value;
	if (ref1Email != ref1EmailConfirm) {
		bootstrapAlertTwoMsg("Ref1IncorrectID", "CorrectIt")
		//bootstrapAlert("You have entered incorrect address of 1st Referee! \n\n Please correct it.")
		ref1Email = "";
		ref1EmailConfirm = "";
		document.Submitappform.Referee1Email.focus();
	return false;
	}
	
	var ref2Email = document.Submitappform.Referee2Email.value;
	var ref2EmailConfirm = document.Submitappform.Referee2EmailConfirm.value;
	if (ref2Email != ref2EmailConfirm) {
		bootstrapAlertTwoMsg("Ref2IncorrectID", "CorrectIt")
		ref2Email = "";
		ref2EmailConfirm = "";
		document.Submitappform.Referee2Email.focus();
	return false;
	}
...
var xthpc = document.Submitappform;
 ...
 {
 	 bootstrapAlertTwoMsg("XthPercentage", "PercentageValidation")
...
function twelvethpc(){
	...
	var xiithpc = document.Submitappform;
	 ...
	 {
	 	 bootstrapAlertTwoMsg("XIIthPercentage", "PercentageValidation")
...
function ugpc(){
	...
	var upc = document.Submitappform;
	 ...
	 {
	 	 bootstrapAlertTwoMsg("UGPercentage", "PercentageValidation")
