...
<!-- JavaScript -->
<script type="text/javascript" language="javascript" src="<s:url value="/JS/CandUpdateRegistration.js"/>"> </script>
...
<s:form method="POST" action="CandUpdateform" theme="xhtml" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}" onsubmit="return validateForm_CandUpdateform();">
