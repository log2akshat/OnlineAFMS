...
with (document.ResetPasswd) {
var alertMsg = ".::ERROR::..\nThe REQUIRED fields are Missing:\n";
if (newpasswd.value == "") alertMsg += "\nPlease enter your New Password!";
if (enteragain.value == "") alertMsg += "\nPlease repeat your New Password!";

var pass1 = document.ResetPasswd.newpasswd;
var pass2 = document.ResetPasswd.enteragain;
...
<body>
	...
	<s:form method="POST" action="ResetPasswd" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}" onsubmit="return validateForm()">
