...
<div id="adminacc_heading"><s:text name="candimg"/> <s:text name="callLetters"/> </div>
...
<tr>
<td width="20" align=center><form id=chkbx name=selectcandidate method=post action=PrintCallLetters.ncra><input type=checkbox name=selectID value=<s:property value="onlineID"/>/></td>
...
<td colspan="2"><strong><a href="CallLetters.ncra?&&offset=<s:property value="prev"/>">Previous</a></strong></td>
...
<td colspan="1"><div align="right"><strong><a href="CallLetters.ncra?&&offset=<s:property value="offset"/>">Next</a></strong></div></td>
</table>
<br>

			  <label>
		      <div align="center">
		        <input type="submit" id ="submit" value="PRINT" name="Select" onclick="javascript:ValidateForm();" />
	          </div>
		      </label>
