...
with (document.adminChangePasswd) {
var alertMsg = ".::ERROR::..\nThe REQUIRED fields are Missing:\n";
if (newpasswd.value == "") alertMsg += "\nPlease enter your New Password!";
if (enteragain.value == "") alertMsg += "\nPlease repeat your New Password!";

var pass1 = document.adminChangePasswd.newpasswd;
var pass2 = document.adminChangePasswd.enteragain;
...
<div id="adminacc_heading"><s:text name="reset_passwd"/></div>	
	...
	<s:form method="POST" action="adminChangePasswd" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}" onsubmit="return validateForm()">
