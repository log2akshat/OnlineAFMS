...
<body>
<div id="adminacc_heading"><s:text name="candimg"/> <s:text name="zeroreportsreceived"/> </div>

<br>
<span class="selectall"><s:text name="selectall"/></span><input type='checkbox' name='selectall' onclick='selectAll(chkbx);'>
<br><br>
...
<tr>
<td width="20" align=center><form id=chkbx name=selectcandidate method=post action=ZeroReportReminder.ncra><input type=checkbox name=selectID value=<s:property value="onlineID"/>/></td>
...
<!--
<td colspan="2"><strong><a href="zeroreport.ncra?&&offset=<s:property value="prev"/>">Previous</a></strong></td>
<td colspan="3"><div align="center"><strong>Showing <s:property value="starter"/> to <s:property value="offset"/> of total <s:property value="Zeroreport"/> Records</strong> </div></td>
<td colspan="1"><div align="right"><strong><a href="zeroreport.ncra?&&offset=<s:property value="offset"/>">Next</a></strong></div></td>
-->
</table>
<br>
