...
<body>
<div id="adminacc_heading"><s:text name="update_candprofile"/></div>
	...
	<s:form method="POST" action="UpdateProcess" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}" onsubmit="return validateForm()">
...
-->	
	...
	<s:if test="%{#user==null}">
	<META HTTP-EQUIV="Refresh" CONTENT="0;URL=/INAT/admin/admin.ncra">
	</s:if>
