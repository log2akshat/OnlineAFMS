...
<div id="profile">
<font size="3"><s:text name="appform_WrittenTestCall"/> : <font color="#660033"> <s:property value="WrittenTestCall"/></font></font>
|
...
<td><s:property value="Referee1"/> <a href="AFDRProcess.ncra?refid=<%=Ref1ID%>"><s:text name="refimg"/></a></td></tr>

<tr><td><s:text name="appform_Referee1Email"/></td>
<td><s:property value="Ref1Email"/></td></tr>

<tr><td><s:text name="appform_Referee2_VP"/></td>
<td><s:property value="Referee2"/> <a href="AFDRProcess.ncra?refid=<%=Ref2ID%>"><s:text name="refimg"/></a></td></tr>
