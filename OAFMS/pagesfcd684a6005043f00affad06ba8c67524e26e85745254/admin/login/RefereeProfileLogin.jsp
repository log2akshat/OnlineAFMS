...
<body>
<div id="adminacc_heading"><s:text name="referee_profile"/></div>
	...
	<s:form method="POST" action="AFDRProcess" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}">
	<tr><td align="center" colspan="2"><s:text name="enter_detail"/></td></tr>
	<s:textfield name="refid" key="ref_id" required="true" onpaste="return false" tooltip="Enter Referee's Reference Number" onKeyPress="return numbersonly(event, false)"/>
