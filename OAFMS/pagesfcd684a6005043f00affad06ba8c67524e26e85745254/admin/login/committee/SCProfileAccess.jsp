...
<body>
<div id="adminacc_heading"><s:text name="SC_Profile"/></div>
	...
	<s:form method="POST" action="SCProfileProcess" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}">
	<tr><td align="center" colspan="2"><s:text name="SC_Profile_detail"/></td></tr>
				
	 <s:select name="scuname" key="sc_Name"
	 headerKey="" headerValue="---- Select SC Member----" list="%{appid}"/>
