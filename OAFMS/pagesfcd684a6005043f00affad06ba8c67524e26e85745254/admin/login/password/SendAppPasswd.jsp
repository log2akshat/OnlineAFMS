...
<div id="adminacc_heading"><s:text name="send_appPasswd"/></div>
	...
	<s:form method="POST" action="appPasswdProcess" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}">
	<tr><td align="center" colspan="2"><s:text name="select_appPasswd"/></td></tr>
