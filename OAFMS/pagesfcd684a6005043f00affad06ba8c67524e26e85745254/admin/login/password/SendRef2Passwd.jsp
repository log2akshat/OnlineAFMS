...
<div id="adminacc_heading"><s:text name="send_Ref2Passwd"/></div>
	...
	<s:form method="POST" action="Ref2PasswdProcess" tooltipConfig="#{'tooltipIcon':'../images/tooltip.png'}">
	<tr><td align="center" colspan="2"><s:text name="select_ref2Passwd"/></td></tr>
