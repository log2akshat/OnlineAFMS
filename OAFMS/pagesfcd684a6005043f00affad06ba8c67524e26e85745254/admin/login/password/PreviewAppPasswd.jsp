...
<body>
<div id="adminacc_heading"><s:text name="send_appPasswd"/></div>
	...
	<br>
	<s:text name="Subject"/><s:text name="ApplicationMailSubject"/>
	<br><br>
	<s:text name="Dear"/> <s:property value="Name"/>,
	<br>
	<br>
	<s:text name="ApplicationMessage"/>
	<br>
	<br>
	...
	<br>
	<br>
	<s:text name="yourpasswd"/> <s:property value="AppPasswd"/>
	<br>
	<br>
	<br>
	...
	<s:form method="POST" action="SendappPasswdFinal">
