...
<body>
<div id="adminacc_heading"><s:text name="send_Ref2Passwd"/></div>
	...
	<font size="3">
	<s:text name="Recipient"/><s:property value="Ref2Email"/>
	<br>
	<s:text name="Sender"/><s:text name="INAT_MailID"/>
	<br>
	<s:text name="Subject"/><s:text name="Referee2MailSubject"/>
	<br><br>
	<s:text name="Dear"/> <s:property value="Referee2"/>,
	<br>
	<br>
	...
	<br>
	<br>
	<s:text name="yourpasswd"/> <s:property value="Ref2Passwd"/>
	<br>
	<br>
	<br>
	...
	<s:form method="POST" action="SendRef2PasswdFinal">
