...
import net.admin.login.dao.DAOSCPasswd;
...
public class SCResetPasswd extends ActionSupport implements ServletRequestAware
{	
	String Newpasswd;
	String Enteragain;
	...
	DAOSCPasswd daopasswd = new DAOSCPasswd();
