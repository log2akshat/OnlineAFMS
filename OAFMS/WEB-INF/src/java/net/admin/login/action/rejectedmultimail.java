...
public class rejectedmultimail extends ActionSupport implements ServletRequestAware
{	
	private HttpServletRequest request;
	
private SendMailBean sendMail;
	
	public rejectedmultimail() {
		...
		if(user!=null)
		{
			   if(user.isAdministrator())
			   {
				...
				////////////////////////////////////////////////////Mail to Rejected Candidates///////////////////////////////////////////////
							...
							String subject = getText("RejectionMailSubject");
							String messageText = "";
							messageText = net.admin.login.action.mailRejection.generateview(AppEmail); //messageString;
