...
import net.admin.login.dao.DAOExcel;
...
public class Excel extends ActionSupport implements ServletRequestAware{
	   ...
	   if(user!=null)
		{
			...
			if(dao.print())
			{
				addActionError(getText("excel_generation_instructions"));   
				return "success";
			}
		}
			   else{
