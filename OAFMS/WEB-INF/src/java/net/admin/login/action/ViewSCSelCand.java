...
import net.admin.login.dao.DAOSCSelCand;
...
public class ViewSCSelCand extends ActionSupport implements ServletRequestAware{
	...
	DAOSCSelCand dao=new DAOSCSelCand();
