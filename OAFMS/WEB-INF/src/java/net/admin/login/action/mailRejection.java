...
public class mailRejection extends ActionSupport {
	
	String msg1 = getText("RejectionMessage");
	String getMsg() {
        return msg1;
    }
	
	String msg2 = getText("rejectionregards");;
	...
	{		
		mailRejection progInstance = new mailRejection();
		Connection connect = null;
		ResultSet result = null;
		Statement stmt = null;
