...
public class DAORejectedCand extends ActionSupport{
	...
	public List<UserList> fetch(int offset)
	{
		try
		{
			...
			//String query = "SELECT OnlineID, Name, DOB, Gender, Email, Telephone, EmailSent FROM applicant WHERE Status='Rejected' ORDER BY OnlineID limit 25 offset "+offset;
			String query = "SELECT OnlineID, Name, DOB, Gender, Email, Telephone, EmailSent FROM applicant WHERE Status='Rejected' ORDER BY OnlineID";
