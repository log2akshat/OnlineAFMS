...
public class DAOAppPasswd extends ActionSupport {
...
////////////////////////////////////////////////////Mail to Applicant/////////////////////////////////////////////////////
			...
			String subject = getText("ApplicationMailSubject");
			String messageText = "";
			messageText = net.admin.application.action.password.mailAppPasswd.generateview(AppEmail); //messageString;
