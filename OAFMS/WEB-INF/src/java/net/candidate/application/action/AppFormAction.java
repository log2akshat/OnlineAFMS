...
import net.candidate.application.dao.DAO;
...
public class AppFormAction extends ActionSupport{
	...
	{	
		try 
		{
			...
			boolean comparing_appform = (RegID == 0); 
			
			if (comparing_appform == false)
			{			
				addActionError(getText("validate_AppAlreadyapplied"));
		        return ERROR;
			}
		...
		if(dao.insert(Passwd, Name,  DOB, Gender, Nationality, Email, CAddress, CPin, CCity, CState, Telephone, PAddress, PPin, PCity, PermanentState, Category, Edu_XthStd, Edu_XthStd_Institute, Edu_XthStd_Board, Edu_XthStd_Year, Edu_XthStd_Grade, Edu_XthStd_Pc, Edu_XIIthStd, Edu_XIIthStd_Institute, Edu_XIIthStd_Board, Edu_XIIthStd_Year, Edu_XIIthStd_Grade, Edu_XIIthStd_Pc, Edu_UG, Edu_UG_Institute, Edu_UG_Board, Edu_UG_Year, Edu_UG_Grade, Edu_UG_Pc, Edu_PG, Edu_PG_Institute, Edu_PG_Board, Edu_PG_Year, Edu_PG_Grade, Edu_PG_Pc, Presentcourse, Coursecompyear, Referee1, Referee1Email, Referee2, Referee2Email, Reason, Appliedbefore1, Appliedbefore2, Interest, GQ_Subject, GQ_Project, GQ_Awards, GQ_Result))
		{
