...
public class DAORef2Passwd extends ActionSupport {
	...
	public boolean send(int oid)
	{
		try{
			...
			System.out.println("JDBC MySQL Refree2 Mail Sending Connection....");
